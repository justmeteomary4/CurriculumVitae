...
\textbf{Postdoctoral Research Fellow} \hfill {Sep 2019 - Apr 2022}\\
...
\section{Education}
\textbf{PhD in Atmospheric Chemistry}  \hfill {2015-2019} \\
...
Thesis: Impact of \ce{C1}-\ce{C3} alkyl nitrates on tropospheric chemistry\\
\begin{innerlist}
...
%\item[2] {\bf Zamyatina M.}, Reeves C.E., Griffiths P.T., K\"ohler M.O., Archibald  A.T. Impact of $\text{C}_\text{1}$-$\text{C}_\text{3}$ alkyl nitrate chemistry on tropospheric ozone: box and global model perspectives. Manuscript in preparation.
