...
{\href {https://mariazamyatina.wordpress.com/}{mariazamyatina.wordpress.com}}
%\end{tabular}%
...
\begin{innerlist}
\item[] {\href {https://www.uea.ac.uk/}{University of East Anglia}} \\
        Modules:
        \begin{innerlist}
...
\item Data analysis and visualization (Python, \Matlab, R, NCL, NCO)
\item Version control (Git)
\item Document preparation (\LaTeX, Microsoft Office)
\item Familiar with ArcGIS
\end{innerlist}

\section{Personal and Professional Development}
\textbf{\href {https://www.ncas.ac.uk/index.php/en/nerc-ppsda-schools/introduction-to-ukca}{UKCA Theory and Practice Workshop}} \hfill {4-8 Jan 2016} \\
Introduction to the main components of the United Kingdom Chemistry and Aerosols model (UKCA), including exercises on adaptation of the model to various research purposes, running it and solving common problems
...
\section{Outreach}
Co-maintainer of the {\href {https://twitter.com/atmoschemuea}{@AtmosChemUEA}} twitter account.
